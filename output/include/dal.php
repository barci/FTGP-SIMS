...
class tDAL
{
	...
	function FillTablesList()
	{
		if($this->lstTables)
			return;
	  $this->lstTables[]=array("name"=>"supplier","varname"=>"supplier");
	  $this->lstTables[]=array("name"=>"category","varname"=>"category");
	  $this->lstTables[]=array("name"=>"product","varname"=>"product");
	  $this->lstTables[]=array("name"=>"customer","varname"=>"customer");
	  $this->lstTables[]=array("name"=>"role","varname"=>"role");
	  $this->lstTables[]=array("name"=>"staff","varname"=>"staff");
	  $this->lstTables[]=array("name"=>"orderdetail","varname"=>"orderdetail");
