...
$layout->blocks["top"][] = "pdf";$page_layouts["supplier_print"] = $layout;
...
//	process selection
	if (@$_REQUEST["mdelete"])
	{
		...
		{
			$keys=array();
			$keys["SupplierID"]=refine($_REQUEST["mdelete1"][mdeleteIndex($ind)]);
			$selected_recs[]=$keys;
		}
	}
	elseif(@$_REQUEST["selection"])
	{
		foreach(@$_REQUEST["selection"] as $keyblock)
		{
			...
			if(count($arr)<1)
				continue;
			$keys=array();
			$keys["SupplierID"]=urldecode($arr[0]);
			$selected_recs[]=$keys;
		}
	}
...
//	SupplierID - 
			$record["SupplierID_value"] = $pageObject->showDBValue("SupplierID", $data, $keylink);
			$record["SupplierID_class"] = $pageObject->fieldClass("SupplierID");
//	ComName - 
			$record["ComName_value"] = $pageObject->showDBValue("ComName", $data, $keylink);
			$record["ComName_class"] = $pageObject->fieldClass("ComName");
//	ConFName - 
			$record["ConFName_value"] = $pageObject->showDBValue("ConFName", $data, $keylink);
			$record["ConFName_class"] = $pageObject->fieldClass("ConFName");
//	ConLName - 
			$record["ConLName_value"] = $pageObject->showDBValue("ConLName", $data, $keylink);
			$record["ConLName_class"] = $pageObject->fieldClass("ConLName");
//	ConTitle - 
			$record["ConTitle_value"] = $pageObject->showDBValue("ConTitle", $data, $keylink);
			$record["ConTitle_class"] = $pageObject->fieldClass("ConTitle");
//	Address - 
...
//	PayMeth - 
			$record["PayMeth_value"] = $pageObject->showDBValue("PayMeth", $data, $keylink);
			$record["PayMeth_class"] = $pageObject->fieldClass("PayMeth");
//	DisType - 
			$record["DisType_value"] = $pageObject->showDBValue("DisType", $data, $keylink);
			$record["DisType_class"] = $pageObject->fieldClass("DisType");
			if($col<$colsonpage)
...
$xt->assign("SupplierID_fieldheadercolumn",true);
$xt->assign("SupplierID_fieldheader",true);
$xt->assign("SupplierID_fieldcolumn",true);
$xt->assign("SupplierID_fieldfootercolumn",true);
$xt->assign("ComName_fieldheadercolumn",true);
$xt->assign("ComName_fieldheader",true);
$xt->assign("ComName_fieldcolumn",true);
$xt->assign("ComName_fieldfootercolumn",true);
$xt->assign("ConFName_fieldheadercolumn",true);
$xt->assign("ConFName_fieldheader",true);
$xt->assign("ConFName_fieldcolumn",true);
$xt->assign("ConFName_fieldfootercolumn",true);
$xt->assign("ConLName_fieldheadercolumn",true);
$xt->assign("ConLName_fieldheader",true);
$xt->assign("ConLName_fieldcolumn",true);
$xt->assign("ConLName_fieldfootercolumn",true);
$xt->assign("ConTitle_fieldheadercolumn",true);
$xt->assign("ConTitle_fieldheader",true);
$xt->assign("ConTitle_fieldcolumn",true);
$xt->assign("ConTitle_fieldfootercolumn",true);
...
$xt->assign("PayMeth_fieldheadercolumn",true);
$xt->assign("PayMeth_fieldheader",true);
$xt->assign("PayMeth_fieldcolumn",true);
$xt->assign("PayMeth_fieldfootercolumn",true);
$xt->assign("DisType_fieldheadercolumn",true);
$xt->assign("DisType_fieldheader",true);
$xt->assign("DisType_fieldcolumn",true);
$xt->assign("DisType_fieldfootercolumn",true);
