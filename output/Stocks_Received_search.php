...
include("include/Stocks_Received_variables.php");
...
$layout->blocks["top"][] = "search";$page_layouts["Stocks_Received_search"] = $layout;
...
$mode = SEARCH_SIMPLE;
$templatefile = "Stocks_Received_search.htm";
...
$params['shortTableName'] = 'Stocks_Received';
