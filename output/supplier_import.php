...
// keys array
$keys[]=AddFieldWrappers("SupplierID");
$keys_present=1;
...
$layout->blocks["top"][] = "import";$page_layouts["supplier_import"] = $layout;
...
$xt->display("supplier_import.htm");
