...
$layout->blocks["top"][] = "details";$page_layouts["Product_Listing_view"] = $layout;
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='Product_Listing_edit.php?".$editlink."'\"");
