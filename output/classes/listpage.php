	...
	{	
		...
		foreach($this->selectedRecs as $keys) 
		{
			...
			if($this->lockingObj)
			{
				...
				$lockSQL = "select * from ".AddTableWrappers("ftgp-sales and inventory mgt system_locking")." where ".AddFieldWrappers("keys")."=".db_prepare_string($lockWhere)." and ".AddFieldWrappers("table")."=".db_prepare_string($this->origTName)." and ".AddFieldWrappers("action")."=1";
