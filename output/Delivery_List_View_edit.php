...
$layout->blocks["top"][] = "details";$page_layouts["Delivery_List_View_edit"] = $layout;
...
$templatefile = ($inlineedit == EDIT_INLINE) ? "Delivery_List_View_inline_edit.htm" : "Delivery_List_View_edit.htm";
...
if ($IsSaved && no_output_done() && $inlineedit == EDIT_SIMPLE)
{
	...
	// redirect
	header("Location: Delivery_List_View_".$pageObject->getPageType().".php?".$keyGetQ);
...
$xt->assign("viewlink_attrs","id=\"viewButton".$id."\" name=\"viewButton".$id."\" onclick=\"window.location.href='Delivery_List_View_view.php?".$viewlink."'\"");
