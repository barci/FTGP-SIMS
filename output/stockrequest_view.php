...
$layout->blocks["top"][] = "details";$page_layouts["stockrequest_view"] = $layout;
...
$arr = array();
$arr['fName'] = "RequestID";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("RequestID");
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "StaffID";
...
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "ReceiveFlag";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("ReceiveFlag");
$fieldsArr[] = $arr;
...
//RequestID - 
	...
	if($mainTableOwnerID=="RequestID")
		$ownerIdValue=$value;
	$xt->assign("RequestID_value",$value);
...
//ProductID - 
	...
	if($mainTableOwnerID=="ProductID")
		$ownerIdValue=$value;
	$xt->assign("ProductID_value",$value);
...
//ReceiveFlag - 
	...
	if($mainTableOwnerID=="ReceiveFlag")
		$ownerIdValue=$value;
	$xt->assign("ReceiveFlag_value",$value);
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='stockrequest_edit.php?".$editlink."'\"");
