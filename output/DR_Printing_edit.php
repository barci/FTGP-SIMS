...
$layout->blocks["top"][] = "details";$page_layouts["DR_Printing_edit"] = $layout;
...
$templatefile = ($inlineedit == EDIT_INLINE) ? "DR_Printing_inline_edit.htm" : "DR_Printing_edit.htm";
...
if ($IsSaved && no_output_done() && $inlineedit == EDIT_SIMPLE)
{
	...
	// redirect
	header("Location: DR_Printing_".$pageObject->getPageType().".php?".$keyGetQ);
...
if(!$data)
{
	...
	{
		header("Location: DR_Printing_list.php?a=return");
		exit();
	}
	else
		$data = array();
...
$xt->assign("viewlink_attrs","id=\"viewButton".$id."\" name=\"viewButton".$id."\" onclick=\"window.location.href='DR_Printing_view.php?".$viewlink."'\"");
