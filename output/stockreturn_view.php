...
$layout->blocks["top"][] = "details";$page_layouts["stockreturn_view"] = $layout;
...
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "customerID";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("customerID");
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "StaffID";
...
//customerID - 
	...
	if($mainTableOwnerID=="customerID")
		$ownerIdValue=$value;
	$xt->assign("customerID_value",$value);
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='stockreturn_edit.php?".$editlink."'\"");
