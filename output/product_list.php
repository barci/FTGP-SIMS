...
$layout->blocks["bare"][] = "mastergrid";$page_layouts["category_masterlist"] = $layout;

$layout = GetPageLayout("category", 'masterlist');
if($layout)
{
...
$viewControls = new ViewControlsContainer(new ProjectSettings("category", PAGE_LIST), PAGE_LIST);
