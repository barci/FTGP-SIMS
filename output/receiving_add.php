...
add_nocache_headers();
include("include/receiving_variables.php");
...
$layout->blocks["top"][] = "details";$page_layouts["receiving_add"] = $layout;
...
if($inlineadd == ADD_INLINE)
	$templatefile = "receiving_inline_add.htm";
else
	$templatefile = "receiving_add.htm";
...
if(isset($_REQUEST['afteradd'])){
		header('Location: receiving_add.php');
			...
			if($inlineadd==ADD_SIMPLE || $inlineadd==ADD_MASTER)
			{
				...
				if (count($keys))
				{
					...
					if($pageObject->pSet->hasEditPage() && $permis['edit'])
						$message .='&nbsp;<a href=\'receiving_edit.php?'.$keylink.'\'>'."Edit".'</a>&nbsp;';
					if($pageObject->pSet->hasViewPage() && $permis['search'])
						$message .='&nbsp;<a href=\'receiving_view.php?'.$keylink.'\'>'."View".'</a>&nbsp;';
				}
				$mesClass = "mes_ok";	
			}
		}
...
if (no_output_done() && $inlineadd==ADD_SIMPLE && $IsSaved)
{
	...
	// redirect
	header("Location: receiving_".$pageObject->getPageType().".php");
