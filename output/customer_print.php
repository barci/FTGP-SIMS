...
$layout->blocks["top"][] = "pdf";$page_layouts["customer_print"] = $layout;
...
$arr = array();
$arr['fName'] = "BRegNo";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("BRegNo");
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "ComName";
...
$arr = array();
$arr['fName'] = "OAddress";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("OAddress");
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "DAddress";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("DAddress");
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "Phone";
...
//	BRegNo - 
			$record["BRegNo_value"] = $pageObject->showDBValue("BRegNo", $data, $keylink);
			$record["BRegNo_class"] = $pageObject->fieldClass("BRegNo");
//	ComName - 
...
//	OAddress - 
			$record["OAddress_value"] = $pageObject->showDBValue("OAddress", $data, $keylink);
			$record["OAddress_class"] = $pageObject->fieldClass("OAddress");
//	DAddress - 
			$record["DAddress_value"] = $pageObject->showDBValue("DAddress", $data, $keylink);
			$record["DAddress_class"] = $pageObject->fieldClass("DAddress");
//	StaffID - 
...
$xt->assign("BRegNo_fieldheadercolumn",true);
$xt->assign("BRegNo_fieldheader",true);
$xt->assign("BRegNo_fieldcolumn",true);
$xt->assign("BRegNo_fieldfootercolumn",true);
...
$xt->assign("OAddress_fieldheadercolumn",true);
$xt->assign("OAddress_fieldheader",true);
$xt->assign("OAddress_fieldcolumn",true);
$xt->assign("OAddress_fieldfootercolumn",true);
$xt->assign("DAddress_fieldheadercolumn",true);
$xt->assign("DAddress_fieldheader",true);
$xt->assign("DAddress_fieldcolumn",true);
$xt->assign("DAddress_fieldfootercolumn",true);
