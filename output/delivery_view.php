...
$layout->blocks["top"][] = "details";$page_layouts["delivery_view"] = $layout;
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='delivery_edit.php?".$editlink."'\"");
