...
$layout->blocks["top"][] = "export";$page_layouts["receiving_export"] = $layout;
...
$xt->display("receiving_export.htm");
...
function ExportToWord($cipherer)
{
	...
	header("Content-Disposition: attachment;Filename=receiving.doc");
...
function ExportToXML($cipherer)
{
	...
	header("Content-Disposition: attachment;Filename=receiving.xml");
