...
$layout->blocks["top"][] = "pdf";$page_layouts["stockreturn_print"] = $layout;
...
//	customerID - 
			$record["customerID_value"] = $pageObject->showDBValue("customerID", $data, $keylink);
			$record["customerID_class"] = $pageObject->fieldClass("customerID");
//	StaffID - 
...
$xt->assign("customerID_fieldheadercolumn",true);
$xt->assign("customerID_fieldheader",true);
$xt->assign("customerID_fieldcolumn",true);
$xt->assign("customerID_fieldfootercolumn",true);
