...
$layout->blocks["top"][] = "details";$page_layouts["DR_Printing_view"] = $layout;
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='DR_Printing_edit.php?".$editlink."'\"");
