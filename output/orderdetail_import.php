...
// keys array
$keys[]=AddFieldWrappers("ODetailID");
$keys_present=1;
...
$layout->blocks["top"][] = "import";$page_layouts["orderdetail_import"] = $layout;
...
$xt->display("orderdetail_import.htm");
