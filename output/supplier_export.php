...
$layout->blocks["top"][] = "export";$page_layouts["supplier_export"] = $layout;
...
$xt->display("supplier_export.htm");
...
function ExportToXML($cipherer)
{
	...
	header("Content-Disposition: attachment;Filename=supplier.xml");
	...
	{
		$values = array();
			$values["SupplierID"] = $pageObject->showDBValue("SupplierID", $row);
			$values["ComName"] = $pageObject->showDBValue("ComName", $row);
			$values["ConFName"] = $pageObject->showDBValue("ConFName", $row);
			$values["ConLName"] = $pageObject->showDBValue("ConLName", $row);
			$values["ConTitle"] = $pageObject->showDBValue("ConTitle", $row);
			...
			$values["PayMeth"] = $pageObject->showDBValue("PayMeth", $row);
			$values["DisType"] = $pageObject->showDBValue("DisType", $row);
...
// write data rows
	...
	{
		$values = array();
			$values["SupplierID"] = $pageObject->getViewControl("SupplierID")->showDBValue($row, "");
			$values["ComName"] = $pageObject->getViewControl("ComName")->showDBValue($row, "");
			$values["ConFName"] = $pageObject->getViewControl("ConFName")->showDBValue($row, "");
			$values["ConLName"] = $pageObject->getViewControl("ConLName")->showDBValue($row, "");
			$values["ConTitle"] = $pageObject->getViewControl("ConTitle")->showDBValue($row, "");
			...
			$values["PayMeth"] = $pageObject->getViewControl("PayMeth")->showDBValue($row, "");
			$values["DisType"] = $pageObject->getViewControl("DisType")->showDBValue($row, "");
		...
		if ($eventRes)
		{
			...
			if($outstr!="")
				$outstr.=",";
			$outstr.='"'.str_replace('"', '""', $values["SupplierID"]).'"';
			if($outstr!="")
				$outstr.=",";
			$outstr.='"'.str_replace('"', '""', $values["ComName"]).'"';
			if($outstr!="")
				$outstr.=",";
			$outstr.='"'.str_replace('"', '""', $values["ConFName"]).'"';
			if($outstr!="")
				$outstr.=",";
			$outstr.='"'.str_replace('"', '""', $values["ConLName"]).'"';
			if($outstr!="")
				$outstr.=",";
			$outstr.='"'.str_replace('"', '""', $values["ConTitle"]).'"';
			if($outstr!="")
				$outstr.=",";
			...
			if($outstr!="")
				$outstr.=",";
			$outstr.='"'.str_replace('"', '""', $values["PayMeth"]).'"';
			if($outstr!="")
				$outstr.=",";
			$outstr.='"'.str_replace('"', '""', $values["DisType"]).'"';
			echo $outstr;
		}
...
// write header
	...
	{
		echo '<td style="width: 100" x:str>'.PrepareForExcel("Supplier ID").'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel("Company Name").'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel("Contact First Name").'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel("Contact Last Name").'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel("Contact Title").'</td>';	
		...
		echo '<td style="width: 100" x:str>'.PrepareForExcel("Payment Method").'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel("Discount Type").'</td>';	
	}
	else
	{
		echo "<td>"."Supplier ID"."</td>";
		echo "<td>"."Company Name"."</td>";
		echo "<td>"."Contact First Name"."</td>";
		echo "<td>"."Contact Last Name"."</td>";
		...
		if ($eventRes)
		{
			...
			echo '</td>';
					...
					echo '<td>';
									...
									if($_REQUEST["type"]=="excel")
						echo PrepareForExcel($values["ComName"]);
					else
						echo $values["ComName"];
			echo '</td>';
							if($_REQUEST["type"]=="excel")
					...
					echo '<td>';
									...
									if($_REQUEST["type"]=="excel")
						echo PrepareForExcel($values["ConFName"]);
					else
						echo $values["ConFName"];
			echo '</td>';
							if($_REQUEST["type"]=="excel")
					echo '<td x:str>';
				else
					echo '<td>';
									...
									if($_REQUEST["type"]=="excel")
						echo PrepareForExcel($values["ConLName"]);
					else
						echo $values["ConLName"];
			echo '</td>';
							if($_REQUEST["type"]=="excel")
					echo '<td x:str>';
				else
					echo '<td>';
									...
									if($_REQUEST["type"]=="excel")
						echo PrepareForExcel($values["ConTitle"]);
					else
						echo $values["ConTitle"];
			echo '</td>';
							if($_REQUEST["type"]=="excel")
					echo '<td x:str>';
				else
			...
			echo '</td>';
					...
					echo '<td>';
									...
									if($_REQUEST["type"]=="excel")
						echo PrepareForExcel($values["PayMeth"]);
					else
						echo $values["PayMeth"];
			echo '</td>';
							if($_REQUEST["type"]=="excel")
					...
					echo '<td>';
									...
									if($_REQUEST["type"]=="excel")
						echo PrepareForExcel($values["DisType"]);
					else
						echo $values["DisType"];
			echo '</td>';
			echo "</tr>";
