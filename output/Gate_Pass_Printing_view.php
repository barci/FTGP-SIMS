...
$layout->blocks["top"][] = "details";$page_layouts["Gate_Pass_Printing_view"] = $layout;
...
$arr = array();
$arr['fName'] = "subtotal";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("subtotal");
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "eta";
...
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "Destination";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("Destination");
$fieldsArr[] = $arr;
...
//subtotal - 
	...
	if($mainTableOwnerID=="subtotal")
		$ownerIdValue=$value;
	$xt->assign("subtotal_value",$value);
	if(!$pageObject->isAppearOnTabs("subtotal"))
		$xt->assign("subtotal_fieldblock",true);
	else
		$xt->assign("subtotal_tabfieldblock",true);
////////////////////////////////////////////
//eta - Short Date
...
//Destination - 
	...
	if($mainTableOwnerID=="Destination")
		$ownerIdValue=$value;
	$xt->assign("Destination_value",$value);
	if(!$pageObject->isAppearOnTabs("Destination"))
		$xt->assign("Destination_fieldblock",true);
	else
		$xt->assign("Destination_tabfieldblock",true);
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='Gate_Pass_Printing_edit.php?".$editlink."'\"");
