...
$layout->blocks["top"][] = "details";$page_layouts["stockreturn_add"] = $layout;
...
if($inlineadd == ADD_INLINE)
	$templatefile = "stockreturn_inline_add.htm";
else
	$templatefile = "stockreturn_add.htm";
...
if(isset($_REQUEST['afteradd'])){
		header('Location: stockreturn_add.php');
			...
			if($inlineadd==ADD_SIMPLE || $inlineadd==ADD_MASTER)
			{
				...
				if (count($keys))
				{
					...
					if($pageObject->pSet->hasEditPage() && $permis['edit'])
						$message .='&nbsp;<a href=\'stockreturn_edit.php?'.$keylink.'\'>'."Edit".'</a>&nbsp;';
					if($pageObject->pSet->hasViewPage() && $permis['search'])
						$message .='&nbsp;<a href=\'stockreturn_view.php?'.$keylink.'\'>'."View".'</a>&nbsp;';
				}
				$mesClass = "mes_ok";	
			}
		}
...
if (no_output_done() && $inlineadd==ADD_SIMPLE && $IsSaved)
{
	...
	// redirect
	header("Location: stockreturn_".$pageObject->getPageType().".php");
