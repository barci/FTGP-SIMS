...
$layout->blocks["top"][] = "pdf";$page_layouts["orderdetail_print"] = $layout;
...
if($mastertable == "orderentry")
{
//	include proper masterprint.php code
	include("include/orderentry_masterprint.php");
	$masterkeys[] = @$_SESSION[$strTableName."_masterkey1"];
	$params = array("detailtable"=>"orderdetail","keys"=>$masterkeys);
	$master = array();
	$master["func"] = "DisplayMasterTableInfo_orderentry";
...
$layout->blocks["bare"][] = "mastergrid";$page_layouts["orderentry_masterprint"] = $layout;
	...
	$layout = GetPageLayout("orderentry", 'masterprint');
	if($layout)
	{
...
$xt->assign("OrdQuant_fieldfootercolumn",true);
$xt->assign("DelQuant_fieldheadercolumn",true);
