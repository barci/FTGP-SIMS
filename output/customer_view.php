...
$layout->blocks["top"][] = "details";$page_layouts["customer_view"] = $layout;
...
//BRegNo - 
	...
	if($mainTableOwnerID=="BRegNo")
		$ownerIdValue=$value;
	$xt->assign("BRegNo_value",$value);
...
//OAddress - 
	...
	if($mainTableOwnerID=="OAddress")
		$ownerIdValue=$value;
	$xt->assign("OAddress_value",$value);
...
//DAddress - 
	...
	if($mainTableOwnerID=="DAddress")
		$ownerIdValue=$value;
	$xt->assign("DAddress_value",$value);
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='customer_edit.php?".$editlink."'\"");
