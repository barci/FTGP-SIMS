...
$layout->blocks["top"][] = "recordcontrols";$page_layouts["stockreceiving_list"] = $layout;
...
$viewControls = new ViewControlsContainer(new ProjectSettings("product", PAGE_LIST), PAGE_LIST);
