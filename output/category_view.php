...
$layout->blocks["top"][] = "details";$page_layouts["category_view"] = $layout;
...
//CatName - 
	...
	if($mainTableOwnerID=="CatName")
		$ownerIdValue=$value;
	$xt->assign("CatName_value",$value);
...
//Desc - 
	...
	if($mainTableOwnerID=="Desc")
		$ownerIdValue=$value;
	$xt->assign("Desc_value",$value);
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='category_edit.php?".$editlink."'\"");
