...
$layout->blocks["top"][] = "details";$page_layouts["Product_Listing_add"] = $layout;
...
if($inlineadd == ADD_INLINE)
	$templatefile = "Product_Listing_inline_add.htm";
else
	$templatefile = "Product_Listing_add.htm";
...
if(isset($_REQUEST['afteradd'])){
		header('Location: Product_Listing_add.php');
			...
			if($inlineadd==ADD_SIMPLE || $inlineadd==ADD_MASTER)
			{
				...
				if (count($keys))
				{
					...
					if($pageObject->pSet->hasEditPage() && $permis['edit'])
						$message .='&nbsp;<a href=\'Product_Listing_edit.php?'.$keylink.'\'>'."Edit".'</a>&nbsp;';
					if($pageObject->pSet->hasViewPage() && $permis['search'])
						$message .='&nbsp;<a href=\'Product_Listing_view.php?'.$keylink.'\'>'."View".'</a>&nbsp;';
				}
				$mesClass = "mes_ok";	
			}
		}
...
if (no_output_done() && $inlineadd==ADD_SIMPLE && $IsSaved)
{
	...
	// redirect
	header("Location: Product_Listing_".$pageObject->getPageType().".php");
