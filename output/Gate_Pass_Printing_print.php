...
$layout->blocks["top"][] = "pdf";$page_layouts["Gate_Pass_Printing_print"] = $layout;
...
//	subtotal - 
			$record["subtotal_value"] = $pageObject->showDBValue("subtotal", $data, $keylink);
			$record["subtotal_class"] = $pageObject->fieldClass("subtotal");
			if($col<$colsonpage)
...
$xt->assign("subtotal_fieldheadercolumn",true);
$xt->assign("subtotal_fieldheader",true);
$xt->assign("subtotal_fieldcolumn",true);
$xt->assign("subtotal_fieldfootercolumn",true);
