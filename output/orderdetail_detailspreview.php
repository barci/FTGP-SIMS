...
$layout->blocks["bare"][] = "detailspreviewgrid";$page_layouts["orderdetail_detailspreview"] = $layout;
...
if($rowcount) {
	...
	//	ODetailID - 
		    ...
		    $value = $viewContainer->showDBValue("ODetailID", $data, $keylink);
			$row["ODetailID_value"] = $value;
	//	OrderID - 
			$viewContainer->recId = $recordsCounter;
...
$xt->load_template("orderdetail_detailspreview.htm");
