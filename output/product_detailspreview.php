...
$layout->blocks["bare"][] = "detailspreviewgrid";$page_layouts["product_detailspreview"] = $layout;
...
{
	$where = "";
		$where .= GetFullFieldName("CatID", $strTableName, false)."=".make_db_value("CatID",$_SESSION[$strTableName."_masterkey1"]);
}
...
if($rowcount) {
	...
	//	UInOrder - 
			$viewContainer->recId = $recordsCounter;
		    $value = $viewContainer->showDBValue("UInOrder", $data, $keylink);
			$row["UInOrder_value"] = $value;
	//	ReOrLevel - 
			$viewContainer->recId = $recordsCounter;
...
$xt->load_template("product_detailspreview.htm");
