...
$layout->blocks["top"][] = "pdf";$page_layouts["product_print"] = $layout;
...
//	CatID - 
			$record["CatID_value"] = $pageObject->showDBValue("CatID", $data, $keylink);
			$record["CatID_class"] = $pageObject->fieldClass("CatID");
//	Usize - 
			$record["Usize_value"] = $pageObject->showDBValue("Usize", $data, $keylink);
			$record["Usize_class"] = $pageObject->fieldClass("Usize");
//	SuppID - 
			$record["SuppID_value"] = $pageObject->showDBValue("SuppID", $data, $keylink);
			$record["SuppID_class"] = $pageObject->fieldClass("SuppID");
//	Uweight - 
...
//	include proper masterprint.php code
	...
	$params = array("detailtable"=>"product","keys"=>$masterkeys);
	$master = array();
	$master["func"] = "DisplayMasterTableInfo_category";
...
$layout->blocks["bare"][] = "mastergrid";$page_layouts["category_masterprint"] = $layout;
	...
	$layout = GetPageLayout("category", 'masterprint');
	if($layout)
	{
...
$xt->assign("Pname_fieldfootercolumn",true);
$xt->assign("CatID_fieldheadercolumn",true);
$xt->assign("CatID_fieldheader",true);
$xt->assign("CatID_fieldcolumn",true);
$xt->assign("CatID_fieldfootercolumn",true);
$xt->assign("Usize_fieldheadercolumn",true);
$xt->assign("Usize_fieldheader",true);
$xt->assign("Usize_fieldcolumn",true);
$xt->assign("Usize_fieldfootercolumn",true);
$xt->assign("SuppID_fieldheadercolumn",true);
$xt->assign("SuppID_fieldheader",true);
$xt->assign("SuppID_fieldcolumn",true);
$xt->assign("SuppID_fieldfootercolumn",true);
$xt->assign("Uweight_fieldheadercolumn",true);
...
$xt->assign("QPerUnit_fieldfootercolumn",true);
...
$xt->assign("USP_fieldfootercolumn",true);
