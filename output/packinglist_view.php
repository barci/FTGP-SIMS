...
$layout->blocks["top"][] = "details";$page_layouts["packinglist_view"] = $layout;
...
//delNo - 
	...
	if($mainTableOwnerID=="delNo")
		$ownerIdValue=$value;
	$xt->assign("delNo_value",$value);
...
//orderNo - 
	...
	if($mainTableOwnerID=="orderNo")
		$ownerIdValue=$value;
	$xt->assign("orderNo_value",$value);
...
//delID - 
	...
	if($mainTableOwnerID=="delID")
		$ownerIdValue=$value;
	$xt->assign("delID_value",$value);
...
//unit - 
	...
	if($mainTableOwnerID=="unit")
		$ownerIdValue=$value;
	$xt->assign("unit_value",$value);
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='packinglist_edit.php?".$editlink."'\"");
