...
$layout->blocks["top"][] = "details";$page_layouts["staff_view"] = $layout;
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='staff_edit.php?".$editlink."'\"");
