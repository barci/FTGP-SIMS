...
$layout->blocks["top"][] = "details";$page_layouts["Pending_Orders_add"] = $layout;
...
if($inlineadd == ADD_INLINE)
	$templatefile = "Pending_Orders_inline_add.htm";
else
	$templatefile = "Pending_Orders_add.htm";
...
if(isset($_REQUEST['afteradd'])){
		header('Location: Pending_Orders_add.php');
			...
			if($inlineadd==ADD_SIMPLE || $inlineadd==ADD_MASTER)
			{
				...
				if (count($keys))
				{
					...
					if($pageObject->pSet->hasEditPage() && $permis['edit'])
						$message .='&nbsp;<a href=\'Pending_Orders_edit.php?'.$keylink.'\'>'."Edit".'</a>&nbsp;';
					if($pageObject->pSet->hasViewPage() && $permis['search'])
						$message .='&nbsp;<a href=\'Pending_Orders_view.php?'.$keylink.'\'>'."View".'</a>&nbsp;';
				}
				$mesClass = "mes_ok";	
			}
		}
...
if (no_output_done() && $inlineadd==ADD_SIMPLE && $IsSaved)
{
	...
	// redirect
	header("Location: Pending_Orders_".$pageObject->getPageType().".php");
