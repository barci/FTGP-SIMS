...
$layout->blocks["top"][] = "details";$page_layouts["orderdetail_view"] = $layout;
...
//ODetailID - 
	...
	if($mainTableOwnerID=="ODetailID")
		$ownerIdValue=$value;
	$xt->assign("ODetailID_value",$value);
	if(!$pageObject->isAppearOnTabs("ODetailID"))
		$xt->assign("ODetailID_fieldblock",true);
	else
		$xt->assign("ODetailID_tabfieldblock",true);
////////////////////////////////////////////
//OrderID - 
...
//OrdQuant - 
	...
	if($mainTableOwnerID=="OrdQuant")
		$ownerIdValue=$value;
	$xt->assign("OrdQuant_value",$value);
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='orderdetail_edit.php?".$editlink."'\"");
