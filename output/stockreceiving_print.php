...
$layout->blocks["top"][] = "pdf";$page_layouts["stockreceiving_print"] = $layout;
...
if($mastertable == "product")
{
//	include proper masterprint.php code
	include("include/product_masterprint.php");
	$masterkeys[] = @$_SESSION[$strTableName."_masterkey1"];
	$params = array("detailtable"=>"stockreceiving","keys"=>$masterkeys);
	$master = array();
	$master["func"] = "DisplayMasterTableInfo_product";
...
$layout->blocks["bare"][] = "mastergrid";$page_layouts["product_masterprint"] = $layout;
	...
	$layout = GetPageLayout("product", 'masterprint');
	if($layout)
	{
...
$xt->assign("RequestID_fieldheadercolumn",true);
...
$xt->assign("ReceiveFlag_fieldheadercolumn",true);
