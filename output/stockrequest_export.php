...
$layout->blocks["top"][] = "export";$page_layouts["stockrequest_export"] = $layout;
...
$xt->display("stockrequest_export.htm");
...
function ExportToWord($cipherer)
{
	...
	header("Content-Disposition: attachment;Filename=stockrequest.doc");
...
function ExportToXML($cipherer)
{
	...
	header("Content-Disposition: attachment;Filename=stockrequest.xml");
