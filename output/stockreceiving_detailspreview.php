...
$layout->blocks["bare"][] = "detailspreviewgrid";$page_layouts["stockreceiving_detailspreview"] = $layout;
...
{
	$where = "";
		$where .= GetFullFieldName("ProductID", $strTableName, false)."=".make_db_value("ProductID",$_SESSION[$strTableName."_masterkey1"]);
}
...
if($rowcount) {
	...
	//	RequestID - 
			$viewContainer->recId = $recordsCounter;
		    $value = $viewContainer->showDBValue("RequestID", $data, $keylink);
			$row["RequestID_value"] = $value;
	//	StaffID - 
			$viewContainer->recId = $recordsCounter;
	...
	//	SupplierID - 
			$viewContainer->recId = $recordsCounter;
		    $value = $viewContainer->showDBValue("SupplierID", $data, $keylink);
			$row["SupplierID_value"] = $value;
	//	ProductID - 
			$viewContainer->recId = $recordsCounter;
...
$xt->load_template("stockreceiving_detailspreview.htm");
