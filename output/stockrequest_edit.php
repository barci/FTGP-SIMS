...
$layout->blocks["top"][] = "details";$page_layouts["stockrequest_edit"] = $layout;
...
$templatefile = "stockrequest_edit.htm";
...
if ($IsSaved && no_output_done() && $inlineedit == EDIT_SIMPLE)
{
	...
	// redirect
	header("Location: stockrequest_".$pageObject->getPageType().".php?".$keyGetQ);
...
if(!$data)
{
	...
	{
		header("Location: stockrequest_list.php?a=return");
		exit();
	}
	else
		$data = array();
...
$xt->assign("viewlink_attrs","id=\"viewButton".$id."\" name=\"viewButton".$id."\" onclick=\"window.location.href='stockrequest_view.php?".$viewlink."'\"");
